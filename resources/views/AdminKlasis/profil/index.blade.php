                ...
                <div class="row">
                    ...
                    <div class="col-lg-8 col-xl-8">
                        <div class="card-box">
                            ...
                            <div class="row mb-2">
                                <div class="col-12">
                                    <a href="{{ route('adminklasis.print') }}" class="btn text-primary p-0" target="_blank"><i class="fe-printer mr-1"></i> Cetak Rekapan Profil Klasis</a>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-12">
                                    ...
                                    {!! Form::open(['route' => ['adminklasis.profil.update', $data->id], 'method' => 'put', 'files' => true]) !!} 
                                    @csrf
                                    
                                    @include('AdminKlasis.profil.fileInputs.foto_kantor')
                                    @include('AdminKlasis.profil.fileInputs.foto_ketua_klasis')
                                    @include('AdminKlasis.profil.fileInputs.fileStrukturOrganisasi')
                                    @include('AdminKlasis.profil.fileInputs.fileSaranaPrasarana')
