                    ...
                    <div class="page-title-box">
                        <div class="page-title-right">
                            <ol class="breadcrumb m-0">
                                ...
                                <li class="breadcrumb-item text-capitalize @if (!Request::segment(0)) active @endif">
                                    <a  href="{{ route('adminmaster.jemaat.index') }}">jemaat</a> 
                                </li>
                                <li class="breadcrumb-item text-capitalize @if (!Request::segment(0)) active @endif">
                                    {!! $pageTitle !!}
                                </li>
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            @if (Request::segment(4) == 'edit')
                                {!! Form::open(['route' => ['adminmaster.jemaat.update', $data->user->id], 'method' => 'put', 'files' => true]) !!}
                            @else
                                {!! Form::open(['route' => 'adminmaster.jemaat.store', 'method' => 'post', 'files' => true]) !!}
                            @endif
                            @csrf
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6">
                                    ...
                                    @include('AdminMaster.jemaat.fileInputs.fotoGereja')
                                    ...
                                    @include('AdminMaster.jemaat.fileInputs.fotoPendeta')
                                    
                                    @include('AdminMaster.jemaat.fileInputs.fileStrukturOrganisasi')
                                    @include('AdminMaster.jemaat.fileInputs.fileSaranaPrasarana')
                            ...
                            <div class="row">
                                <div class="col">
                                    ...
                                    <div class="form-group mb-3">
                                        @if (Request::segment(4) == 'detail')
                                        <a href="{{route('adminmaster.jemaat.edit', $data->id)}}" class="btn btn-primary waves-effect waves-light">
                                            {!! $iconTombolUbah ?? '' !!} Ubah
                                        </a>
                                        @else
                                        ...
                                        @endif
                                        <a href="{{ route('adminmaster.jemaat.index') }}" class="btn waves-effect waves-light">
                            ...
                            @if(Request::segment(3) != 'create' && Request::segment(4) == 'edit')
                                @include('AdminMaster.jemaat.modals.delete_foto_gereja_modal')
                                @include('AdminMaster.jemaat.modals.delete_foto_pendeta_modal')
                                @include('AdminMaster.jemaat.modals.deleteFileStrukturOrganisasiModal')
                                @include('AdminMaster.jemaat.modals.deleteFileSaranaPrasaranaModal')    
                            @endif
