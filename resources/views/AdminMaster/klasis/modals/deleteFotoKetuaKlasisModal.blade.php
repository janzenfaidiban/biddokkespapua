    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                Apakah Anda yakin ingin menghapus foto KetuaKlasis ini? Tindakan ini tidak dapat dibatalkan.
            </div>
            <div class="modal-footer">
                <button type="button" class="btn btn-secondary" data-dismiss="modal">Batal</button>
                <form action="{{ route('adminmaster.jemaat.delete.fotoKetuaKlasis', $data->user->id) }}" method="POST">
                    @csrf
                    @method('DELETE')
