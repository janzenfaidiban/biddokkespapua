                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            @if(Request::segment(4) == 'edit')
                                {!! Form::open(['route' => ['adminmaster.masterdata.suku.update', $data->id], 'method' => 'put', 'files' => true]) !!}
                            @else
                                {!! Form::open(['route' => 'adminmaster.masterdata.suku.store', 'method' => 'post', 'files' => true]) !!}
                            @endif
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="text" id="suku" @if(Request::segment(4) == 'detail') disabled @endif  name="suku" class="form-control" value="{{old('suku') ?? $data->suku ?? ''}}">
                                        @if ($errors->has('suku'))
                                            <span class="text-danger" role="alert">
                                                <small class="pt-1 d-block"><i class="fe-alert-triangle mr-1"></i> {{
                                                    $errors->first('suku') }}</small>
                                            </span>
                                        @endif
                                    </div>
                            ...
                            <div class="row">
                                <div class="col-12">
                                    ...
                                    <div class="form-group">
                                            ...
                                            <a href="{{ route('adminmaster.masterdata.suku.edit', $data->id) }}" class="btn btn-primary waves-effect waves-light">
                                            ...
                                            @endif
                                            <a href="{{ route('adminmaster.masterdata.suku') }}" class="btn btn-outline-dark waves-effect waves-light">
